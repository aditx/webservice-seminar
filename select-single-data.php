<?php
  ...
  $idTBL_T_SEMINAR = $_REQUEST['idTBL_T_SEMINAR'];
	...
	$result = mysql_query("SELECT * FROM TBL_T_SEMINAR a left outer join TBL_M_SEMINAR b on a.idTBL_M_SEMINAR = b.idTBL_M_SEMINAR where a.idTBL_T_SEMINAR = '$idTBL_T_SEMINAR'", $con);
